...
for filename in os.listdir("C:/Users/Alberto/Documents/GitHub/pytorch-wavenet-tesi/pytorch-wavenet-tesi/annotations"):
    if filename.startswith("sound-") and filename.endswith(".json"): 
        ...
        with open(os.path.join("C:/Users/Alberto/Documents/GitHub/pytorch-wavenet-tesi/pytorch-wavenet-tesi/annotations", f"sound-{file_id}.json")) as f:
            data = json.load(f)
            if "house / techno" in data.get("genres", []):
                print("trovato")
                #cerca il file audio
                for audio_filename in os.listdir("C:/Users/Alberto/Documents/GitHub/pytorch-wavenet-tesi/pytorch-wavenet-tesi/audio/wav"):
                    if audio_filename.startswith(file_id) and audio_filename.endswith(".wav"):
                        audio_path = os.path.join("C:/Users/Alberto/Documents/GitHub/pytorch-wavenet-tesi/pytorch-wavenet-tesi/audio/wav", f"{audio_filename}")
                        print(f"{audio_path}")
